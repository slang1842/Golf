...
REAL_LAND_PLACES = {"Green" => 1,"Fairway" => 3, "Next fairway" => 4,"Raf" => 6, "For green" => 7, "Fairway sand" => 8, "Green sand" => 9, "Hole" => 11, "Semi raf" => 5, "Wood" => 10, "Water" => 13, "Hazard" => 12, "Out of bonds" => 14 }
